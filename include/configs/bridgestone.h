...
#ifndef __BRIDGESTONE_H
#define __BRIDGESTONE_H
...
#define JAILHOUSE_ENV \
	"jh_mmcboot=" \
		"setenv fdt_file bridgestone-root.dtb;"\
...
#define XEN_BOOT_ENV \
	    "domu-android-auto=no\0" \
            ...
            "dom0fdt_file=bridgestone-dom0.dtb\0" \
            "xenboot_common=" \
...
/* Link Definitions */
	...
	#define FDT_FILE	"fdt_file=bridgestone-cockpit-a72.dtb\0"
#elif defined(CONFIG_TARGET_IMX8QM_CUSTOM_A53_ONLY)
	#define FDT_ADDR	"fdt_addr=0x83000000\0"
	#define FDT_FILE	"fdt_file=bridgestone-cockpit-a53.dtb\0"
#else
	#define FDT_ADDR	"fdt_addr=0x83000000\0"
...
#include "bridgestone_android.h"
#elif defined (CONFIG_ANDROID_AUTO_SUPPORT)
#include "bridgestone_android_auto.h"
#elif defined(CONFIG_IMX8_TRUSTY_XEN)
#include "bridgestone_trusty_xen.h"
#endif
