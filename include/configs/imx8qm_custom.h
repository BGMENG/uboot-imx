...
#ifndef __IMX8QM_CUSTOM_H
#define __IMX8QM_CUSTOM_H
...
#ifdef CONFIG_TARGET_IMX8QM_CUSTOM_A72_ONLY
...
#ifdef CONFIG_TARGET_IMX8QM_CUSTOM_A53_ONLY
...
#ifndef CONFIG_TARGET_IMX8QM_CUSTOM_A72_ONLY
...
#define JAILHOUSE_ENV \
	"jh_mmcboot=" \
		"setenv fdt_file imx8qm-custom-root.dtb;"\
...
#define XEN_BOOT_ENV \
	    "domu-android-auto=no\0" \
            ...
            "dom0fdt_file=imx8qm-custom-dom0.dtb\0" \
            "xenboot_common=" \
...
#define CONFIG_EXTRA_ENV_SETTINGS		\
	...
	"boot_fdt=try\0" \
	FDT_FILE \
	"mmcdev="__stringify(CONFIG_SYS_MMC_ENV_DEV)"\1" \
	"mmcpart=" __stringify(CONFIG_SYS_MMC_IMG_LOAD_PART) "\1" \
...
#if defined(CONFIG_TARGET_IMX8QM_CUSTOM_A72_ONLY)
	#define FDT_ADDR	"fdt_addr=0xC3000000\0"
	#define FDT_FILE	"fdt_file=imx8qm-custom-cockpit-a72.dtb\0"
#elif defined(CONFIG_TARGET_IMX8QM_CUSTOM_A53_ONLY)
	#define FDT_ADDR	"fdt_addr=0x83000000\0"
	#define FDT_FILE	"fdt_file=imx8qm-custom-cockpit-a53.dtb\0"
#else
	#define FDT_ADDR	"fdt_addr=0x83000000\0"
...
#if defined(CONFIG_TARGET_IMX8QM_CUSTOM_A53_ONLY)
#define CONFIG_SYS_SDRAM_BASE		0x80000000
#define PHYS_SDRAM_1			0x80000000
#define PHYS_SDRAM_2			0x880000000
#define PHYS_SDRAM_1_SIZE		0x40000000	/* 1 GB */
#define PHYS_SDRAM_2_SIZE		0x80000000	/* 2 GB */
#elif defined(CONFIG_TARGET_IMX8QM_CUSTOM_A72_ONLY)
...
#include "imx8qm_custom_android.h"
#elif defined (CONFIG_ANDROID_AUTO_SUPPORT)
#include "imx8qm_custom_android_auto.h"
#elif defined(CONFIG_IMX8_TRUSTY_XEN)
#include "imx8qm_custom_trusty_xen.h"
#endif


#endif /* __IMX8QM_CUSTOM_H */
