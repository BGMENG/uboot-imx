...
#ifndef __IMX8QM_YAMAHA_H
#define __IMX8QM_YAMAHA_H
...
#ifdef CONFIG_TARGET_IMX8QM_YAMAHA_A53_ONLY
...
#ifndef CONFIG_TARGET_IMX8QM_YAMAHA_A72_ONLY
...
#define JAILHOUSE_ENV \
	"jh_mmcboot=" \
		"setenv fdt_file imx8qm-yamaha-root.dtb;"\
...
#define XEN_BOOT_ENV \
	    "domu-android-auto=no\0" \
            ...
            "dom0fdt_file=imx8qm-yamaha-dom0.dtb\0" \
            "xenboot_common=" \
...
#if defined(CONFIG_TARGET_IMX8QM_YAMAHA_A72_ONLY)
	#define FDT_ADDR	"fdt_addr=0xC3000000\0"
	#define FDT_FILE	"fdt_file=imx8qm-yamaha-cockpit-a72.dtb\0"
#elif defined(CONFIG_TARGET_IMX8QM_YAMAHA_A53_ONLY)
	#define FDT_ADDR	"fdt_addr=0x83000000\0"
	#define FDT_FILE	"fdt_file=imx8qm-yamaha-cockpit-a53.dtb\0"
#else
	#define FDT_ADDR	"fdt_addr=0x83000000\0"
...
#if defined(CONFIG_TARGET_IMX8QM_YAMAHA_A53_ONLY)
#define CONFIG_SYS_SDRAM_BASE		0x80000000
#define PHYS_SDRAM_1			0x80000000
#define PHYS_SDRAM_2			0x880000000
#define PHYS_SDRAM_1_SIZE		0x40000000	/* 1 GB */
#define PHYS_SDRAM_2_SIZE		0x80000000	/* 2 GB */
#elif defined(CONFIG_TARGET_IMX8QM_YAMAHA_A72_ONLY)
...
#include "imx8qm_yamaha_android.h"
#elif defined (CONFIG_ANDROID_AUTO_SUPPORT)
#include "imx8qm_yamaha_android_auto.h"
#elif defined(CONFIG_IMX8_TRUSTY_XEN)
#include "imx8qm_yamaha_trusty_xen.h"
#endif


#endif /* __IMX8QM_YAMAHA_H */
